...
// bon de commande
@Data
@Entity(name = "purchase_order_note")
public class PurchaseOrderNote extends OrderNote {
    ...
    @OneToMany(mappedBy = "purchaseOrderNote")
    private List<OrderNoteLine> orderNoteLinesList;
